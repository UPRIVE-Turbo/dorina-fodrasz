# Dorina Fodrász — Weboldal Projekt

## Mit kell csinálnod
Építs egy **egyoldalas, magyar nyelvű landing page-et** a(z) **Dorina Fodrász** (Fodrászat, Miskolc) számára.
...
- Hívd meg az AIDesigner `create_editor_session` toolt a cég nevével: "Dorina Fodrász"
